...
var namesAged5OrMore = animals.Where(animal => animal.Age >= 5)
                                .Select(animal => animal.Name);

var namesStartingWithA = animals.Where(animal =>animal.Name.StartsWith('A'))
                                .Select(animal => animal.Name);

var maleBrownAnimals = animals.Where(animal => animal.Gender == Gender.Male && animal.Color.ToLower() == "brown")
                                .Select(animal => animal.Name);

var firstAnimalNameLongerThan10Characters = animals.FirstOrDefault(animal => animal.Name.Length > 10);
